...
add wave -noupdate /pipetest/pipe0/ldi
...
add wave -noupdate /pipetest/dccache
...
add wave -noupdate /pipetest/pipe0/wbcache
add wave -noupdate /pipetest/pipe0/wbpa
...
WaveRestoreCursors {{Cursor 1} {43728 ps} 0}
